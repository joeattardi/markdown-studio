                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
                        ...
                        <p className="text-slate-600">
                            See your changes instantly with our side-by-side preview mode. Write and
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
                        ...
                        <p className="text-slate-600">
                            Your content never leaves your device. Work with confidence knowing your
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
                        ...
                        <p className="text-slate-600">
                            A clean, distraction-free interface that lets you focus on what matters
                            most—your writing.
                        </p>
                    </div>
                </div>
